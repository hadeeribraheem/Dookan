...
@section('content')
    ...
    <section class="section">
        <div class="section-body customer-profile">
            ...
            <p class="section-lead">{{ __('keywords.change_info') }}</p>

            <div class="row mt-sm-4">
                <div class="col-12 col-md-12 col-lg-7">
                    <div class="card">
                        <form method="POST" action="{{ route('update.user', Auth::user()->id) }}" enctype="multipart/form-data" class="needs-validation" novalidate="">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        @else
                                            <p id="NoImg">{{ __('keywords.no_image') }}</p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        <label>{{ __('keywords.password') }} <span style="font-size: 0.9em; color: gray; font-style: italic;">{{ __('keywords.leave_blank') }}</span></label>
