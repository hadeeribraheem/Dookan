                            ...
                            <div class="product-card">
                                <div class="product-image">
                                    ...
                                    <div class="product-icons d-flex flex-column">
                                        <a href="{{ route('products.show', $product['id'], ['lang' => app()->getLocale()]) }}" class="icon view" data-bs-toggle="tooltip" data-bs-placement="left" title="{{ __('keywords.show_product', ['name' => $product['name']]) }}">
